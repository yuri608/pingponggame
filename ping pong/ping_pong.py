...
#Игровая сцена:
back = (30, 252,1) # цвет фона (background)
win_width = 600
win_height = 500
...
racket1 = Player('badminton.png', 30, 200, 4, 50, 150) # при созданни спрайта добавляется еще два параметра
racket2 = Player('badminton.png', 520, 200, 4, 50, 150)
